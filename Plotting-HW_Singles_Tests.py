# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 21:33:04 2020
...
HW = 'C:/Users/Sondre/Desktop/Single_Simulations/CFD_results'

gofor = HW   

stuff= [f for f in os.listdir(gofor) if not (f.endswith('.bat'))]
print(stuff)
for g in stuff:#[0:1]: #for many folders
    ...
    for u in odb_names:#[0:1]:
        try:
             ...
             np.savez(plot_path+g,
                      ...
                      radz=Radi)
             #plt.savefig('D:/PhD/Simuleringer/HW_plots/'+g+u[:-4]+'.png')
             plt.close()
        except:
Z             pass