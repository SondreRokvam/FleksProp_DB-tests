...
for u in odb_names:#[0:1]:
    ...
    fig.suptitle('Simulation: '+u+', Series: Mesh Convergence', fontsize=16)
    ...
    np.savez(plot_path,
             ...
             radz=Radi)
    #plt.savefig('C:/Users/Jon/Desktop/HW_plots/'+g+u[:-4]+'.png')
    plt.close()
